            ...
            case CompressionTypeGzip:
                {
                    ...
                    using var gZipStream = new GZipStream(new ReadOnlyMemoryStream(chunkData), CompressionMode.Decompress, false);
            ...
            case CompressionTypeZlib:
                {
                    ...
                    using var deflateStream = new ZLibStream(new ReadOnlyMemoryStream(chunkData), CompressionMode.Decompress, false);
